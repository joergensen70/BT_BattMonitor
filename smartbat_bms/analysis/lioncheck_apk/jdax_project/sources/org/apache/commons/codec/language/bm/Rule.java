                    ...
                    if (strTrim.length() == 0) {
                        ...
                        if (strTrim.startsWith(HASH_INCLUDE)) {
                            ...
                            if (strArrSplit.length != 4) {
                                ...
                                try {
                                    str2 = str;
                                    arrayList.add(new Rule(stripQuotes(strArrSplit[0]), stripQuotes(strArrSplit[1]), stripQuotes(strArrSplit[2]), parsePhonemeExpr(stripQuotes(strArrSplit[3])), i2, str2) { // from class: org.apache.commons.codec.language.bm.Rule.2
