    ...
    public ValueAnimator mo8clone() {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo12clone = propertyValuesHolderArr[i2].mo12clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo12clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo12clone.getPropertyName(), propertyValuesHolderMo12clone);
            }
        }
        return valueAnimator;
    }
