...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo8clone() {
        ...
        for (Node node : this.mNodes) {
            Node nodeM9clone = node.m9clone();
            map.put(node, nodeM9clone);
            animatorSet.mNodes.add(nodeM9clone);
            animatorSet.mNodeMap.put(nodeM9clone.animation, nodeM9clone);
            ArrayList arrayList = null;
            nodeM9clone.dependencies = null;
            nodeM9clone.tmpDependencies = null;
            nodeM9clone.nodeDependents = null;
            nodeM9clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM9clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m9clone() {
            try {
                ...
                node.animation = this.animation.mo8clone();
                return node;
