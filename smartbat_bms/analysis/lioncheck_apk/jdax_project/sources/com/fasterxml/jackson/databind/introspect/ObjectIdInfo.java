...
public class ObjectIdInfo {
    ...
    */
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("ObjectIdInfo: propName=").append(this._propertyName).append(", scope=");
        Class<?> cls = this._scope;
        StringBuilder sbAppend2 = sbAppend.append(cls == null ? "null" : cls.getName()).append(", generatorType=");
        Class<? extends ObjectIdGenerator<?>> cls2 = this._generator;
        return sbAppend2.append(cls2 != null ? cls2.getName() : "null").append(", alwaysAsId=").append(this._alwaysAsId).toString();
    }
}
