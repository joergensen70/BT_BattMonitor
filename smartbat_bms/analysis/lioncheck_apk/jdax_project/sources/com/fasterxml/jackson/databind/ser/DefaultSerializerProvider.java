...
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    public void serializeValue(JsonGenerator jsonGenerator, Object obj) throws IOException {
        ...
        if (rootName == null) {
            ...
            if (zIsEnabled) {
                PropertyName propertyNameFindRootName = this._rootNames.findRootName(obj.getClass(), this._config);
                jsonGenerator.writeStartObject();
                jsonGenerator.writeFieldName(propertyNameFindRootName.simpleAsEncoded(this._config));
            }
    ...
    public void serializeValue(JsonGenerator jsonGenerator, Object obj, JavaType javaType) throws IOException {
        ...
        if (rootName == null) {
            ...
            if (zIsEnabled) {
                jsonGenerator.writeStartObject();
                jsonGenerator.writeFieldName(this._rootNames.findRootName(obj.getClass(), this._config).simpleAsEncoded(this._config));
            }
        } else if (rootName.length() == 0) {
            zIsEnabled = false;
        } else {
    ...
    public void serializeValue(JsonGenerator jsonGenerator, Object obj, JavaType javaType, JsonSerializer<Object> jsonSerializer) throws IOException {
        ...
        if (rootName == null) {
            ...
            if (zIsEnabled) {
                jsonGenerator.writeStartObject();
                jsonGenerator.writeFieldName((javaType == null ? this._rootNames.findRootName(obj.getClass(), this._config) : this._rootNames.findRootName(javaType, this._config)).simpleAsEncoded(this._config));
            }
        } else if (rootName.length() == 0) {
            zIsEnabled = false;
        } else {
