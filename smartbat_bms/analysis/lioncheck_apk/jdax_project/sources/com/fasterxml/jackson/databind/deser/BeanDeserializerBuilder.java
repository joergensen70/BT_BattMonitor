...
public class BeanDeserializerBuilder {
    ...
    public JsonDeserializer<?> build() {
        ...
        return new BeanDeserializer(this, this._beanDesc, beanPropertyMap, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, z3);
    }
    ...
    public JsonDeserializer<?> buildBuilderBased(JavaType javaType, String str) {
        ...
        return new BuilderBasedDeserializer(this, this._beanDesc, beanPropertyMap, this._backRefProperties, this._ignorableProps, this._ignoreAllUnknown, z3);
    }
}
