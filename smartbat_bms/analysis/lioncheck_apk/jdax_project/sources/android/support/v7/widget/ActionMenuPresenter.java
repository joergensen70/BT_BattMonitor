...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        int i10 = 0;
        int i11 = 0;
        ?? r0 = actionMenuPresenter;
        while (i10 < size) {
            MenuItemImpl menuItemImpl2 = visibleItems.get(i10);
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = r0.getItemView(menuItemImpl2, r0.mScrapActionButtonView, viewGroup);
                if (r0.mScrapActionButtonView == null) {
                    r0.mScrapActionButtonView = itemView;
                }
                if (r0.mStrictWidthLimit) {
                ...
                boolean z3 = (i8 > 0 || z2) && i4 > 0 && (!r0.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z4 = z3;
                if (z3) {
                    View itemView2 = r0.getItemView(menuItemImpl2, r0.mScrapActionButtonView, viewGroup);
                    i2 = size;
                    if (r0.mScrapActionButtonView == null) {
                        r0.mScrapActionButtonView = itemView2;
                    }
                    if (r0.mStrictWidthLimit) {
                    ...
                    z3 = z4 & (!r0.mStrictWidthLimit ? i4 + i11 <= 0 : i4 < 0);
                } else {
                    i2 = size;
                }
                if (z3 && groupId2 != 0) {
                ...
                i2 = size;
                r3 = r2;
                menuItemImpl2.setIsActionButton(r3);
            }
            i10++;
            r0 = this;
            r2 = r3;
