...
public class TransportMediator extends TransportController {
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        TransportMediatorCallback transportMediatorCallback = new TransportMediatorCallback() { // from class: android.support.v4.media.TransportMediator.1
        ...
        this.mView = view;
        this.mDispatcherState = view.getKeyDispatcherState();
